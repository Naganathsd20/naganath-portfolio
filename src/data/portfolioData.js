export const personalInfo = {
  ...
  whoIAm: "I am an enthusiastic Computer Science student focused on software development. Throughout my engineering journey, I have built full-stack web applications, completed software development internships, and solved 350+ Data Structures & Algorithms problems on LeetCode and GeeksforGeeks.",
  
  whyCS: "I chose Computer Science because I enjoy solving logical problems and turning ideas into functional software.",
  
  careerGoal: "Seeking Software Developer / Full Stack Developer opportunities where I can apply my Java and MERN stack skills to write clean, reliable code.",
  
  whatIEnjoyBuilding: [
    {
      title: "Full Stack MERN Web Apps",
      desc: "Building responsive web portals with React frontend, Node/Express backend, and MongoDB databases."
    },
    {
      title: "Java & Algorithmic Solutions",
      desc: "Solving coding problems, practicing Data Structures, and writing clean Object-Oriented Java code."
    }
  ],
  
  currentLearning: ["Java", "MERN Stack", "Data Structures & Algorithms", "AI Fundamentals"],
  status: "Actively seeking Software Developer Internship & Entry-Level Full-Time Roles.",
  languages: ["English (Professional)", "Kannada (Native)", "Hindi (Fluent)"]
};

export const stats = [
  { label: "Projects Completed", value: "10+", change: "MERN & Web Apps", id: "projects" },
  { label: "Internship Experience", value: "6 Months", change: "2 Web Internships", id: "experience" },
  { label: "Technologies Learned", value: "12+", change: "Full Stack & Java", id: "stack" },
  { label: "DSA Problems Solved", value: "350+", change: "LeetCode & GFG", id: "dsa" }
];
...
export const experience = [
  {
    ...
    certificateUrl: "/Codec_Internship_Certificate.pdf",
    certificateImage: "/Codec_Internship_Certificate.png"
  },
  {
    ...
    certificateUrl: "/InternPe_Internship_Certificate.png",
    certificateImage: "/InternPe_Internship_Certificate.png"
  }
];
